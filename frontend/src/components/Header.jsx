...
const Header = () => {
  return (
    ...
    text-center my-20'>
        ...
        sm:text-6xl sm:max-w-[600px] mx-auto 
        mt-10 text-center'>Turn text to<span className='text-blue-600'> image</span>
        , in seconds.</h1>
        ...
        <button className='sm:text-lg text-white bg-black border w-auto mt-12 px-12 py-2.5 flex items-center gap-2 rounded-full'>
            Generate Images 
